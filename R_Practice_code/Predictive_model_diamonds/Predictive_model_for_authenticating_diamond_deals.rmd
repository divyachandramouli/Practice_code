...
========================================================
Use EDA to develop a quanyitative understanding of the diamond market
Build a predictive model of diamonds to figure out whethere a given diamond is a good deal or a rip-off
Exploring this can help undertsnad what goes into the price of a diamond
...
```
The linear trendline does not go through the center of the data in some key places 
- misses curving in the center of the plot and should slope up more towards the end
